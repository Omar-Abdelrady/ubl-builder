 ...
 */
class Address extends GenericAggregateComponent_1.default {
    /**     *
    ...
    addAddressLine(value) {
        ...
        const itemToPush = value instanceof AddressLine_1.AddressLine ? value : new AddressLine_1.AddressLine({ line: value });
