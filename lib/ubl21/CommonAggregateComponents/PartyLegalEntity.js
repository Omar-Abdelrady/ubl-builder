...
const ParamsMap = {
    ...
    corporateRegistrationScheme: {
        ...
        min: 0,
        max: 1,
        classRef: CorporateRegistrationScheme_1.CorporateRegistrationScheme,
    },
};
/**
 * More info: http://www.datypic.com/sc/ubl21/e-cac_PartyLegalEntity.html
 */
class PartyLegalEntity extends GenericAggregateComponent_1.default {
    constructor(content) {
     ...
     * @param value
     */
    setCorporateRegistrationScheme(value) {
        if (value instanceof CorporateRegistrationScheme_1.CorporateRegistrationScheme) {
